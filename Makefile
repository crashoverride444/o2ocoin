...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 3? 12 10:22:02 2014
# Project:  o2ocoin.pro
# Template: app
...
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -Ibuild -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -ID:/boost_1_53_0 -I/opt/local/include/db48 -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/include -Ibuild -F/opt/local/Library/Frameworks -F/opt/local/lib
LINK          = /usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -fstack-protector-all -arch x86_64 -pthread -Xarch_x86_64 -mmacosx-version-min=10.9
LIBS          = $(SUBLIBS) -F/opt/local/Library/Frameworks -F/opt/local/lib  -lminiupnpc /Users/rt77789/code/project/o2ocoin/src/leveldb/libleveldb.a /Users/rt77789/code/project/o2ocoin/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -LD:/boost_1_53_0/stage/lib -L/opt/local/lib/db48 -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_chrono-mt -F/opt/local/Library/Frameworks -F/opt/local/lib -L/opt/local/lib -framework QtGui -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
