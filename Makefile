#############################################################################
# Makefile for building: O2ocoin-Qt.app/Contents/MacOS/O2ocoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 3? 14 21:00:54 2014
# Project:  o2ocoin.pro
# Template: app
# Command: /opt/local/bin/qmake -o Makefile o2ocoin.pro
#############################################################################
...
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -Ibuild -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -Isrc -Isrc/json -Isrc/qt -I$(HOME)/lib -Isrc/leveldb/include -Isrc/leveldb/helpers -I$(HOME)/lib/boost_1_53_0 -I$(HOME)/lib/db-4.8.30.NC/build_unix -I$(HOME)/lib/openssl-1.0.1f/include -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/include -Ibuild -F/opt/local/Library/Frameworks -F/opt/local/lib
LINK          = /usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -Wl,--allow-multiple-definition -fstack-protector-all -arch x86_64 -pthread -Xarch_x86_64 -mmacosx-version-min=10.9
LIBS          = $(SUBLIBS) -F/opt/local/Library/Frameworks -F/opt/local/lib  -L$(HOME)/lib/miniupnpc -lminiupnpc /Users/rt77789/code/project/o2ocoin/src/leveldb/libleveldb.a /Users/rt77789/code/project/o2ocoin/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -L$(HOME)/lib/boost_1_53_0/stage/lib -L$(HOME)/lib/db-4.8.30.NC/build_unix -L$(HOME)/lib/openssl-1.0.1f -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_chrono-mt -F/opt/local/Library/Frameworks -F/opt/local/lib -L/opt/local/lib -framework QtGui -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		o2ocoin.pro
QMAKE_TARGET  = O2ocoin-Qt
DESTDIR       = 
TARGET        = O2ocoin-Qt.app/Contents/MacOS/O2ocoin-Qt
...
all: Makefile O2ocoin-Qt.app/Contents/PkgInfo O2ocoin-Qt.app/Contents/Resources/empty.lproj O2ocoin-Qt.app/Contents/Info.plist O2ocoin-Qt.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Users/rt77789/code/project/o2ocoin/src/leveldb/libleveldb.a /Users/rt77789/code/project/o2ocoin/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) O2ocoin-Qt.app/Contents/MacOS/ || $(MKDIR) O2ocoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: o2ocoin.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
...
O2ocoin-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) O2ocoin-Qt.app/Contents || $(MKDIR) O2ocoin-Qt.app/Contents 
	@$(DEL_FILE) O2ocoin-Qt.app/Contents/PkgInfo
	@echo "APPL????" >O2ocoin-Qt.app/Contents/PkgInfo
O2ocoin-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) O2ocoin-Qt.app/Contents/Resources || $(MKDIR) O2ocoin-Qt.app/Contents/Resources 
	@touch O2ocoin-Qt.app/Contents/Resources/empty.lproj
	
O2ocoin-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) O2ocoin-Qt.app/Contents || $(MKDIR) O2ocoin-Qt.app/Contents 
	@$(DEL_FILE) O2ocoin-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.8,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,O2ocoin-Qt,g" -e "s,@TYPEINFO@,????,g" share/qt/Info.plist >O2ocoin-Qt.app/Contents/Info.plist
O2ocoin-Qt.app/Contents/Resources/bitcoin.icns: src/qt/res/icons/bitcoin.icns
	@$(CHK_DIR_EXISTS) O2ocoin-Qt.app/Contents/Resources/ || $(MKDIR) O2ocoin-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) O2ocoin-Qt.app/Contents/Resources/bitcoin.icns
	@$(COPY_FILE) src/qt/res/icons/bitcoin.icns O2ocoin-Qt.app/Contents/Resources/bitcoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/O2ocoin-Qt0.8.3 || $(MKDIR) build/O2ocoin-Qt0.8.3 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/splashscreen.h src/hashblock.h src/sph_blake.h src/sph_skein.h src/sph_keccak.h src/sph_jh.h src/sph_groestl.h src/sph_bmw.h src/sph_types.h src/qt/macdockiconhandler.h build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/blake.c src/bmw.c src/groestl.c src/jh.c src/keccak.c src/skein.c build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/O2ocoin-Qt0.8.3/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/O2ocoin-Qt0.8.3/ && (cd `dirname build/O2ocoin-Qt0.8.3` && $(TAR) O2ocoin-Qt0.8.3.tar O2ocoin-Qt0.8.3 && $(COMPRESS) O2ocoin-Qt0.8.3.tar) && $(MOVE) `dirname build/O2ocoin-Qt0.8.3`/O2ocoin-Qt0.8.3.tar.gz . && $(DEL_FILE) -r build/O2ocoin-Qt0.8.3


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /Users/rt77789/code/project/o2ocoin/src/leveldb/libleveldb.a; cd /Users/rt77789/code/project/o2ocoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
distclean: clean
	-$(DEL_FILE) -r O2ocoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/rt77789/code/project/o2ocoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/rt77789/code/project/o2ocoin/src/leveldb && CC=/usr/bin/clang CXX=/usr/bin/clang++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Users/rt77789/code/project/o2ocoin/build/build.h: FORCE
	cd /Users/rt77789/code/project/o2ocoin; /bin/sh share/genbuild.sh /Users/rt77789/code/project/o2ocoin/build/build.h
